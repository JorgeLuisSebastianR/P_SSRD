...
<div class="card mt-3">
    ...
    <div class="card-header d-inline-flex">
        <a href="{{route('estudiantes.index')}}" class="btn btn-success">
            <i class="fa-solid fa-arrow-turn-down-left" >Volver</i>     
        </a>
    </div>

    <div class="card-body">
        <form action="{{-- route('estudiantes.store') --}}" method="POST" enctype="multipart/form-data" id="create">
            @include('estudiantes\partials\from')
        </form>
